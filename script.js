...
// Filling the ivan object with data. This is not ideal way of filling the object with data. The object we created was empty and then we had to fill it here with the data, but there is another way to do that, because object.create accepts a second parameter.
ivan.name = 'Ivan';
ivan.yearOfBirth = 1990;
ivan.job = 'teacher';
...
var lily = Object.create(personProto, {
    name: { value: 'Lily' },
